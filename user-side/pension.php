...
$query_images = "SELECT image, title, description, category, price_per_day, facilities, contact_email, facebook_link FROM uploads WHERE category = 'pension' ORDER BY created_at DESC";
...
<head>
    ...
    <link href="css/pension.css" rel="stylesheet">
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active actives" href="Pension.php">Pension</a>
                </li>
                <li class="nav-item">
                ...
                <div class="search-container d-flex justify-content-end pb-3">
                    ...
                    <script>
                        function search() {
                            ...
                            if (query.includes('pension') || query.includes('puerto princesa')) {
                                window.location.href = 'https://www.google.com/search?q=pension+houses+in+Puerto+Princesa';
                            } else {
